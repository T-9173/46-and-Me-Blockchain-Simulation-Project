...
def generate_mnemonic(num_words: int = 24) -> str:
    ...
    'alien', 'align', 'alike', 'alive', 'all', 'alley', 'allow', 'almost', 'alone', 'along',
    'already', 'also', 'alter', 'always', 'amateur', 'amazing', 'ambition', 'ambulance', 'among', 'amount',
    ...
    'blame', 'blanket', 'blast', 'bleak', 'blend', 'bless', 'blind', 'block', 'blood', 'blossom',
    'blouse', 'blue', 'blur', 'blush', 'board', 'boat', 'body', 'boil', 'bold', 'bomb',
    'bone', 'bonus', 'book', 'boost', 'booth', 'border', 'borrow', 'boss', 'bottom', 'bounce',
    'box', 'boy', 'bracket', 'brain', 'branch', 'brand', 'brass', 'brave', 'bread', 'breeze',
    'brick', 'bridge', 'brief', 'bright', 'bring', 'brisk', 'broccoli', 'broken', 'bronze', 'broom',
    'brother', 'brown', 'brush', 'bubble', 'buddy', 'budget', 'buffalo', 'build', 'bulb', 'bulk',
    'bullet', 'bundle', 'bunker', 'burden', 'burger', 'burst', 'bus', 'business', 'busy', 'butter',
    'buyer', 'buzz', 'cable', 'cactus', 'cage', 'cake', 'call', 'calm', 'camera', 'camp',
    ...
    'caution', 'cave', 'ceiling', 'celebrate', 'celer', 'cell', 'cement', 'census', 'century', 'cereal',
    'certain', 'chair', 'chalk', 'champion', 'change', 'chaos', 'chapter', 'charge', 'chase', 'chat',
    'cheap', 'check', 'cheek', 'cheese', 'chef', 'chemical', 'cherry', 'chess', 'chest', 'chicken',
    ...
    'come', 'comfort', 'comic', 'commit', 'common', 'company', 'concert', 'conduct', 'confirm', 'congress',
    'connect', 'consider', 'control', 'convince', 'cook', 'cool', 'copper', 'copy', 'coral', 'core',
    'corn', 'correct', 'cost', 'cotton', 'couch', 'cough', 'country', 'couple', 'course', 'cousin',
    ...
    'draft', 'drag', 'dragon', 'drama', 'drastic', 'draw', 'dream', 'dress', 'drift', 'drill',
    ...
    'garlic', 'gas', 'gasp', 'gate', 'gather', 'gauge', 'gaze', 'general', 'genius', 'genre',
    ...
    'glove', 'glow', 'glue', 'goal', 'goat', 'goddess', 'gold', 'good', 'goose', 'gorilla',
    ...
    'hawk', 'hazard', 'head', 'heal', 'health', 'heart', 'heavy', 'hedgehog', 'height', 'hello',
    ...
    'image', 'imagine', 'imitate', 'immense', 'immune', 'impact', 'impose', 'improve', 'impulse', 'inch',
    ...
    'insect', 'inside', 'inspire', 'install', 'institute', 'instruct', 'instrument', 'insult', 'insurance', 'intend',
    'interest', 'internet', 'interpret', 'interval', 'into', 'intrude', 'invade', 'invent', 'invest', 'invite',
    ...
    'kite', 'kitten', 'knee', 'knife', 'knock', 'know', 'lab', 'label', 'labor', 'ladder',
    ...
    'portion', 'position', 'positive', 'possible', 'post', 'potato', 'pottery', 'poverty', 'powder', 'power',
    ...
    'rate', 'rather', 'raven', 'raw', 'reach', 'react', 'read', 'ready', 'real', 'reason',
    ...
    'ritua', 'rival', 'river', 'road', 'roast', 'robot', 'robust', 'rocket', 'romance', 'roof',
    'rookie', 'room', 'rose', 'rotate', 'rough', 'round', 'route', 'royal', 'rubber', 'rude',
    'rug', 'rule', 'run', 'rural', 'sad', 'saddle', 'sadness', 'safe', 'sail', 'salad',
    ...
    'tired', 'tissue', 'title', 'toast', 'tobacco', 'today', 'toe', 'together', 'toilet', 'token',
    ...
    'walnut', 'want', 'warfare', 'warm', 'warrior', 'wash', 'wasp', 'waste', 'watch', 'water',
...
def address_from_mnemonic(mnemonic: str) -> str:
    ...
    return make_address(mnemonic.strip())
